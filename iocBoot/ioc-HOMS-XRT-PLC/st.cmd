...
epicsEnvSet("MOTOR_PREFIX",    "XRTM1:HOMS:MMS:")
epicsEnvSet("MOTOR_NAME",      "YUP")
epicsEnvSet("DESC",            "Main.M1 / M1-Yup")
epicsEnvSet("EGU",             "um")
epicsEnvSet("PREC",            "3")
...
epicsEnvSet("DESC",            "Main.M5 / M1-Pitch")
...
epicsEnvSet("DESC",            "Main.M2 / M1-Ydwn")
epicsEnvSet("EGU",             "um")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M3 / M1-Xup")
epicsEnvSet("EGU",             "um")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M4 / M1-Xdwn")
epicsEnvSet("EGU",             "um")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M6 / M1-Bender")
epicsEnvSet("EGU",             "um")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
